...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_pystyy_ostamaan_edullisen_lounaan_kun_kortilla_rahaa_sen_verran(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        #kortilla nyt rahaa 2.50euroa
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")

    def test_kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_kortilla_rahaa_sen_verran(self):
        self.kortti.lataa_rahaa(2)
        #saldo nyt 12euroa
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        #kortilla nyt rahaa 4euroa
        self.kortti.syo_maukkaasti()
